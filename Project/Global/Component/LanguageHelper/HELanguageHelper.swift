//
//  HELanguageHelper.swift
//  Project
//
//  Created by weixhe on 2018/3/14.
//  Copyright © 2018年 com.weixhe. All rights reserved.
//

import UIKit

public let kHEAppWillChangeLanguageNotification =  NSNotification.Name(rawValue: "he_app_will_change_language")

private let kSupportLanguage = "he_support_language_key"
private let kCurrentLanguage = "he_current_language_key"
private let kSysLanguage = "FollowSystem"
private let kAutoLanguage = "he_auto_language"
private let kUniqueSimplifiedChinese = "unique_simplified_chinese"
private var kBundlePath = "he_cus_bundle_path"
class HELanguageHelper: NSObject, SelfAware {
    
    // 该方法相当于OC中的load()方法
    static func awake() {
        object_setClass(Bundle.main, HEBundleEX.self /*NSClassFromString("HEBundleEX")*/)
        let language = HELanguageHelper.getLanguage()
    ...
    class func setLanguage(language: String) {
        ...
        NotificationCenter.default.post(name: kHEAppWillChangeLanguageNotification, object: nil)
    }

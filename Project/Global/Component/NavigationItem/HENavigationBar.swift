...
open class HENavigationBar: UIView {
    // background 相关属性
    ...
    var rightBarButtonItem: HEBarButtonItem? {
        willSet {
    ...
    var leftBarButtonItems: [HEBarButtonItem]? {
        willSet {
            self.clearItemBy(inner_key: "leftItem")
    ...
    var rightBarButtonItems: [HEBarButtonItem]? {
        willSet {
            self.clearItemBy(inner_key: "rightItem")

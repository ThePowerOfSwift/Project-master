...
open class HEKeyboardTextView: UIView {
    ...
    // MARK: Property
    lazy var textView: HEExpandTextView = HEExpandTextView(frame: self.tools.calculateTextViewFrame(leftMargin: 0, rightMargin: 0, superview: self))
...
// MARK: - HEKeyboardTextView 键盘
extension HEKeyboardTextView {
...
extension HEKeyboardTextView: UITextViewDelegate {

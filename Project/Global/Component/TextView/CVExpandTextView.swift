...
open class CVExpandTextView: CVPlaceholderTextView {
    
    public enum CVExpandDirection {
        case toUp   // 向上延伸
        case toDown // 向下延伸
    }
    // MARK: Property
    public var expandDirection: CVExpandDirection = .toDown     // 延伸方向选择，默认向下延伸
...
// MARK: - CVExpandTextView 计算高度
extension CVExpandTextView {
    /// 根据行数line计算高度46

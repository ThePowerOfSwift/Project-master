...
class Check {
    ...
    class func number(_ text: String) -> Bool {
        return Validate.number(text).isValid()
    }
    
    /// 检查纯字母
    class func alphabet(_ text: String) -> Bool {
        return Validate.alphabet(text).isValid()
    }
    
    /// 检查纯汉字
    class func chinese(_ text: String) -> Bool {
        return Validate.chinese(text).isValid()
    }

...
//  Project
//
//  Created by weixhe on 2018/3/29.
...
struct HEClient {
    ...
    static let shared: HEClient = HEClient()
    ...
    /// 上传文件
    func upload(path: String, parameters: [String:Any]? = nil, datas:[HEUploadParam], success: Success? = nil, failture: Failture? = nil) {
